...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      orders: {
        Row: {
          ...
          distribution_mode: Database['public']['Enums']['distribution_mode'] | null;
    ...
    Views: {
      v_open_orders: {
        Row: {
          ...
          max_open_severity: Database['public']['Enums']['issue_severity'] | null;
    ...
    Enums: {
      ...
      doc_stage: 'persiapan' | 'sembelih' | 'masak' | 'salur' | 'kirim' | 'terkirim' | 'umum';
