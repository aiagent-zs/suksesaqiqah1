...
export const ORDER_STATUS_META: Record<OrderStatus, StatusMeta> = {
  ...
  slaughtering: { label: 'Pemotongan', className: 'bg-violet-50 text-violet-700 border-violet-200' },
...
export const ANIMAL_STATUS_META: Record<AnimalStatus, StatusMeta> = {
  ...
  distributed: { label: 'Terdistribusi', className: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
};
